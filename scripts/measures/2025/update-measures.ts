    ...
    try {
        ...
        for (let i = 0; i < changeData.length; i++) {
            ...
            if (!change.category) {
                ...
                if (Lib.isOnlyAdminClaims(change) && (change.metricType !== 'costScore' || !change.isInverse)) warning(
                ...
                if (isNew && !change.measureSets && Lib.isOnlyAdminClaims(change) && change.category !== 'cost') {
                    change.measureSets = [];
                }
