...
const sourceFile = "../../../staging/2020/benchmarks/source.csv";
//File to write converted data to. If file does not exist, it will be created.
const targetFile = "../../../staging/2020/benchmarks/benchmarks.csv";
...
parser.on('readable', function(){
  ...
  while (record = parser.read()) {
    ...
    if (record['Measure Title'].charAt(0) == '"' && record['Measure Title'].charAt(s.length-1) == '"') {
