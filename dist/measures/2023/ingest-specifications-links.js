...
(0, merge_ecqm_ehr_links_1.default)(measures, getFileDataIfExists(ecqmEhrLinksPath, true));
(0, merge_web_interface_links_1.default)(measures, getFileDataIfExists(webInterfaceLinksPath, true));
(0, merge_claims_links_1.default)(measures, getFileDataIfExists(claimsLinksPath, true));
(0, merge_cqm_links_1.default)(measures, getFileDataIfExists(cqmLinksPath, true));
(0, merge_pi_links_1.default)(measures, getFileDataIfExists(piLinksPath, true));
(0, merge_cost_links_1.default)(measures, getFileDataIfExists(costLinksPath, true));
(0, merge_ecqm_data_1.default)(measures, getFileDataIfExists(generatedEcqmPath));
(0, merge_ecqm_data_1.default)(measures, getFileDataIfExists(manuallyCreatedEcqmPath));
(0, merge_stratifications_1.default)(measures, getFileDataIfExists(AdditionalStratificationsPath));
